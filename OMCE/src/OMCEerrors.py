...
error[ 53]=["Function ""%s"" is used with %s parameters!",['<name>','<n>']]
...
error[ 76]=['Incorrect number of parameters for "%s" command!',['<command>']]
...
error[101]=['Exception in user-function "%s": %s!',['<func>','<message>']]
error[102]=['Python coding is disabled!',[]]
